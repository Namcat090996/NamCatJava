...
public class AppKT_240524_CatHN1 {
	...
	{
	    strChuoiB = TinhToanCongChuoiSo.canBangChuoi(strChuoiA, strChuoiB);
	}
	if(strChuoiA.length() < strChuoiB.length())
	{
	    strChuoiA = TinhToanCongChuoiSo.canBangChuoi(strChuoiB, strChuoiA);
	}
	
	//Calculate addition of two sequences of numbers
	List<Integer> ketQua = TinhToanCongChuoiSo.tinhToanCongChuoi(strChuoiA, strChuoiB);
