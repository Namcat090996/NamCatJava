...
public class DataAccess {
    ...
    private static final String DATABASE_LINK = "jdbc:mysql://localhost:3306/qlmonan?useUnicode=true&characterEncoding=UTF-8&useSSL=false&allowPublicKeyRetrieval=true";
