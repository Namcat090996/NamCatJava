...
public class SinhVienBus {
	...
	//Khai báo câu lệnh MySQL
	String strFind = "Select MaSV, HoTen, GioiTinh, NgaySinh, DienThoai, Email, DiaChi, chuyenkhoa.MaKhoa, TenKhoa from sinhvien, chuyenkhoa where sinhvien.MaKhoa = chuyenkhoa.MaKhoa";
	...
	try {
		...
		objSV.setDiaChi(rs.getString("DiaChi"));
		objSV.setMaKhoa(rs.getString("MaKhoa"));
		objSV.setTenKhoa(rs.getString("TenKhoa"));
