...
public class fmDanhSachSV extends javax.swing.JFrame {
	...
	String tieuDe[] = new String[]{"Mã sinh viên", "Họ Tên", "Giới tính", "Ngày sinh", "Điện thoại", "Email", "Địa chỉ", "Mã Khoa", "Tên Khoa"};
	
	//Khai báo model để hiển thị dữ liệu lên table
	DefaultTableModel model = new DefaultTableModel(tieuDe, 0);
	
	//Khai báo đối tượng từ lớp SinhVienBussiness
	SinhVienBus sinhVienBus = new SinhVienBus();
