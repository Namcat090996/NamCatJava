 ...
 */
public class DanhSachThiSinh extends javax.swing.JFrame {
	...
	try {
	    ...
	    java.util.logging.Logger.getLogger(DanhSachThiSinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	...
	java.awt.EventQueue.invokeLater(new Runnable() {
	    public void run() {
		new DanhSachThiSinh().setVisible(true);
	    }
	});
    }
