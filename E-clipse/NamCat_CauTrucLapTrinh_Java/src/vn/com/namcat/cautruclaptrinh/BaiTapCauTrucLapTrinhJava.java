...
//Khai báo thư viện để sử dụng Scanner
import java.util.Scanner;

/**
 * 
 */
public class BaiTapCauTrucLapTrinhJava {
	...
	public static void main(String[] args) {
		...
		//Khai báo 01 đối tượng để hỗ trợ lấy thông tin từ bàn phím
		...
		double khoangCach = 1235.454;
		// − Nghiệm x của phương trình bậc 1
		float x = 25.5f;
		// − Biệt thức Δ của phương trình bậc 2
		float delta = 35.456f;
		
		System.out.printf("Tuổi người: %d\n" + "Độ dài cạnh tam giác: %f\n" + "Một chữ số: %s\n" + "Một chữ cái: %s\n" + "Số lượng cây trong thành phố: %d\n" + "Khoảng cách giữa các hành tinh: %f\n" + "Nghiệm x của phương trình bậc 1: %f\n" + "Biệt thức Δ của phương trình bậc 2: %f\n", tuoiNguoi, canhTamGiac, chuSo, chuCai, soLuongCay, khoangCach, x, delta);
		...
		System.out.printf("Số thực là: %f\n" + "Số nguyên là: %d\n" + "Số nguyên dài là: %d\n" + "Kí tự là: %s\n", soThuc, soNguyen, soNguyenDai, kiTu);
		...
		*/
		...
		System.out.printf("Số thực 1 = %f/tSố thực 2 = %f\n", soThuc1, soThuc2);
		
		//Bài tập 6:
		
		//Khai báo biến
		
		float a = 5.141f, b = -2f, c = 0.8f;
		...
		System.out.printf("Đáp án câu 7a: %.2f\n" + "Đáp án câu 7b: %.2f\n", cau7a, cau7b);
		...
		{
			System.out.printf("Division of %.2f & %.2f is: Please enter a non-zero b number", a, b);
		}
		...
		if(a+b>c && a+c>b && b+c>a)
		{
			...
			System.out.printf("Độ dài đường cao ha = %.2f\n", ha);	System.out.printf("Độ dài đường cao hb = %.2f\n", hb);	System.out.printf("Độ dài đường cao hc = %.2f\n", hc);
			
			System.out.printf("Độ dài đường trung tuyến ma = %.2f\n", ma);	System.out.printf("Độ dài đường trung tuyến mb = %.2f\n", mb);	System.out.printf("Độ dài đường trung tuyến mc = %.2f\n", mc);
			
			System.out.printf("Độ dài đường phân giác ga = %.2f\n", ga);	System.out.printf("Độ dài đường phân giác gb = %.2f\n", gb);	System.out.printf("Độ dài đường phân giác gc = %.2f\n", gc);	
		...
		{
			System.out.println("Bạn cần phải nhập lại độ dài 3 cạnh của tam giác đảm bảo điều kiện: Tổng 2 cạnh phải lớn hơn cạnh còn lại");
		}
		...
		int chuSoDau = (a/1000)%10;
		
		int chuSoThuHai = (a/100)%10;
		
		int chuSoThuBa = (a/10)%10;
		
		int chuSoCuoi = a%10;
		
		int tongSo = chuSoDau + chuSoThuHai + chuSoThuBa + chuSoCuoi;
		
		System.out.println("Tổng số là: " + tongSo);
		
		System.out.println("Chữ số đầu là: " + chuSoDau);
		
		System.out.println("Chữ số cuối là: " + chuSoCuoi);
		...
		char chuSoHangNghin = numString.charAt(0); 
		
		char chuSoDonVi = numString.charAt(3); 
		
		System.out.println("Chữ số đầu là: " + chuSoDonVi);
		
		System.out.println("Chữ số cuối là: " + chuSoHangNghin);
		...
		System.out.printf("Tên của sinh viên thứ nhất: %s\n", hoTen1);	System.out.printf("Tên của sinh viên thứ hai: %s\n", hoTen2);
		
		System.out.printf("Tuổi của sinh viên thứ nhất: %d\n", tuoi1);	System.out.printf("Tuổi của sinh viên thứ hai: %d\n", tuoi2);
		
		System.out.printf("Điểm toán của sinh viên thứ nhất: %.2f\n", diemToan1);	System.out.printf("Điểm toán của sinh viên thứ hai: %.2f\n", diemToan2);
		
		System.out.printf("Điểm tin của sinh viên thứ nhất: %.2f\n", diemTin1);		System.out.printf("Điểm tin của sinh viên thứ hai: %.2f\n", diemTin2);
		
		System.out.printf("Điểm trung bình của sinh viên thứ nhất: %.2f\n", ((diemToan1*2)+diemTin1)/2);	System.out.printf("Điểm trung bình của sinh viên thứ hai: %.2f\n", ((diemToan2*2)+diemTin2)/2);
		...
		System.out.print("Nhập số thực a (cm): ");
