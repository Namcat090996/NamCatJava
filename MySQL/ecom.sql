...
INSERT INTO `category` VALUES ('Laptop'),('Màn hình'),('Máy tính bảng'),('Tai nghe'),('Tay cầm chơi game'),('Điện thoại'),('Đồng hồ thông minh');
...
INSERT INTO `order` VALUES (1,'admin','2024-12-04','PE',5000000,'SF001','Electronics',NULL,'admin');
...
INSERT INTO `role` VALUES ('AD','admin'),('CT','customer');
...
INSERT INTO `status` VALUES ('AC','ACCEPTED'),('CA','CANCELLED'),('PE','PENDINNG');
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_role` FOREIGN KEY (`role`) REFERENCES `role` (`role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('admin','$2a$10$1QD9Gmdb7AwRI9wuHZDQmeCHEotxy6W.RTAMLlRE9cqzcJmMGxPnG','admin@gmail.com','admin','0123456789','AD','Da Nang'),('customer','$2a$10$CKVLu/PweNXh5Zsh2h8Sv.lr2yBSMTaKdSXB/MS0rOm2M2n3.xQ1q','customer@gmail.com','customeer','0123456788','CT','Ha Noi');
