...
public class DangNhapServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.println("<html>"
				+ "<head><title>Làm việc với Servlet</title></head>"
				+ "<body><div style='width: 100%; text-align: center;'><h1>Đăng nhập hệ thống</h1></div>"
				+ "<form method='post'><field>"
				+ "<legend>Nhập thông tin đăng nhập</legend>"
				+ "Tên đăng nhập: <input type='text' name='txtTenDangNhap';/><br>"
				+ "Mật khẩu: <input type='text' name='txtMatKhau';/><br><input type='submit' name='btnDangNhap' value='Đăng nhập'/><br>"
				+ "</field></form></body>"
				+ "</html>");
